...
# Switches
#set_property PACKAGE_PIN V17 [get_ports {en_p}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {en_p}]
#set_property PACKAGE_PIN V16 [get_ports {dis_p}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {dis_p}]
...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {out_p}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out_p}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports en_p]						
	set_property IOSTANDARD LVCMOS33 [get_ports en_p]
#set_property PACKAGE_PIN T18 [get_ports btnU]						
	#set_property IOSTANDARD LVCMOS33 [get_ports btnU]
set_property PACKAGE_PIN W19 [get_ports dis_p]						
	set_property IOSTANDARD LVCMOS33 [get_ports dis_p]
